...
public class BulletTestRendering extends DemoApplication {
    ...
    // ObjectArrayList();
    /*
     * private DefaultCollisionConfiguration collisionConfiguration; private
     * CollisionDispatcher dispatcher; private BroadphaseInterface broadphase;
    ...
    private Stage stage = new Stage(new StageGeneratorFlat(20, 20, 1).generate(), 0, 0);
    ...
    public static void main(String[] args) throws LWJGLException {
        ...
        LWJGL.main(args, 800, 600, "Bullet Test Rendering", ccdDemo);
    }
