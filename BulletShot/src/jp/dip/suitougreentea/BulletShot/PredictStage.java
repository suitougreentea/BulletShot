...
public class PredictStage extends Stage {
    ...
    Vector3f keepingPlayerPosition;
    ...
    public void setKeepingPlayerPosition(Vector3f pos){
        ...
        BulletShot.getLogger().info(String.format("Set position to : %s",pos.toString()));
    }
    
    /*public void setPlayerPosition(float x, float y, float z){
        objPlayer.getRigidBody().getMotionState().setWorldTransform(new Transform(new Matrix4f(
                new Quat4f(0,0,0,1),new Vector3f(x,y,z), 1.0f)));
    }*/
    ...
    public Transform[] getPredictedPath(int rot,int vrot){
        ...
        playerRigidBody.setMotionState(new DefaultMotionState(new Transform(new Matrix4f(
          new Quat4f(0,0,0,1),keepingPlayerPosition, 1.0f))));
